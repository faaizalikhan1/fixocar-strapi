"use strict";(self.webpackChunkfixostrapi=self.webpackChunkfixostrapi||[]).push([[5905],{76761:(te,B,a)=>{a.r(B),a.d(B,{default:()=>ln});var t=a(67294),c=a(68547),m=a(96315),A=a(67109),L=a(85018),M=a(4585),D=a(29728),k=a(46273),f=a(7681),s=a(35961),v=a(67838),pe=a(49066),J=a(27361),$=a.n(J),ne=a(18721),oe=a.n(ne),Q=a(18446),re=a.n(Q),ue=a(11700),ae=a.n(ue),I=a(97132),Y=a(49656),K=a(45697),r=a.n(K),l=a(72735),p=a(11057),u=a(63985),T=a(47144),Z=a(18374),j=a(49386),q=a(26478),U=a(13588),w=a(27821),b=a(5002),N=a(28702),qe=a(70968);const _e=(0,w.default)(N.Flex)`
  border-radius: 50%;
...
`;function fe({component:e,dzName:n,index:o,isActive:i,isInDevelopmentMode:g,onClick:d}){const{modifiedData:E,removeComponentFromDynamicZone:R}=(0,U.Z)(),{schema:{displayName:h}}=$()(E,["components",e],{schema:{}}),x=O=>{O.stopPropagation(),R(n,o)};return t.createElement(et,{as:"button",alignItems:"center",direction:"column",className:i?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,type:"button",onClick:d},t.createElement(me,{isActive:i}),t.createElement(N.Box,{marginTop:1,maxWidth:"100%"},t.createElement(N.Typography,{variant:"pi",fontWeight:"bold",ellipsis:!0},h)),g&&t.createElement(xe,{as:"button",onClick:x,type:"button"},t.createElement(qe.default,null)))}fe.defaultProps={component:null,isActive:!1,isInDevelopmentMode:!1,onClick(){}},fe.propTypes={component:r().string,dzName:r().string.isRequired,index:r().number.isRequired,isActive:r().bool,isInDevelopmentMode:r().bool,onClick:r().func};const tt=fe,Oe=w.default.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,mt=(0,w.default)(f.K)`
  ...
  align-items: center;
`;function ye({customRowComponent:e,components:n,addComponent:o,name:i,targetUid:g}){const{isInDevelopmentMode:d}=(0,U.Z)(),[E,R]=(0,t.useState)(0),{formatMessage:h}=(0,I.useIntl)(),x=y=>{E!==y&&R(y)},O=()=>{o(i)};return t.createElement(Oe,{className:"dynamiczone-row",isFromDynamicZone:!0},t.createElement("td",{colSpan:12},t.createElement(dt,{paddingLeft:8},t.createElement(pt,{horizontal:!0,spacing:2},d&&t.createElement("button",{type:"button",onClick:O},t.createElement(mt,{spacing:1},t.createElement(ct,null),t.createElement(l.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600"},h({id:(0,b.Z)("button.component.add"),formatMessage:"Add a component"})))),n.map((y,C)=>t.createElement(tt,{key:y,dzName:i,index:C,component:y,isActive:E===C,isInDevelopmentMode:d,onClick:()=>x(C)})))),t.createElement(ut,null,n.map((y,C)=>{const P={customRowComponent:e,component:y};return t.createElement(s.x,{tabId:`${C}`,key:y,style:{display:E===C?"block":"none"}},t.createElement("table",null,t.createElement("tbody",null,t.createElement(Pe,st(it({},P),{isFromDynamicZone:!0,targetUid:g,key:y})))))}))))}ye.defaultProps={addComponent(){},components:[],customRowComponent:null,name:null},ye.propTypes={addComponent:r().func,components:r().instanceOf(Array),customRowComponent:r().func,name:r().string,targetUid:r().string.isRequired};const ft=ye,gt=(0,w.default)(s.x)`
  table {
    width: 100%;
    white-space: nowrap;
  }
